...
object Types:
  ...
  extension (b: BlockNo) def blockNoValue: Long = b
  ...
  extension (e: EpochNo) def epochNoValue: Long = e
  ...
  extension (t: TxIndex) def txIndexValue: Int = t
  ...
  extension (b: BlockHeaderHash) def toHash32: Hash32 = b
  ...
  extension (t: TxHash) def txHashToHash32: Hash32 = t
  ...
  extension (s: ScriptHash) def scriptHashToHash28: Hash28 = s
  ...
  extension (p: PolicyId) def policyIdToHash28: Hash28 = p
  ...
  extension (p: PoolId) def poolIdToHash28: Hash28 = p
  ...
  extension (v: VrfKeyHash) def vrfKeyHashToHash32: Hash32 = v
  ...
  extension (k: KesKeyHash) def kesKeyHashToHash32: Hash32 = k
